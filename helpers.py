...
def switch(route1, route2):
    ...
    return (house1.get_route().get_length(), house1.get_route()), \
        (house2.get_route().get_length(), house2.get_route())
...
def check_switch_cap(route_1, route_2):
    ...
    if difference > 0:
        return (battery_2.get_used_cap() + difference) \
           < battery_2.get_capacity()
